...
/**
 * é ou não PAR é ou não IMPAR é ou não maior que 10 o dobro do valor digitado é
 * ou não primo Cenário para testes: Ao informar o número 2, deve retornar "é
 * par", "não é impar", "não é maior que 10", "o dobro de 2 é 4", "é primo" Ao
 * informar o número 11, deve retornar "não é par", "é impar", "é maior que 10",
 * "o dobro de 11 é 22", "é primo"
 */
